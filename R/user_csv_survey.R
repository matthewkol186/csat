...
analyzeData <- function(dat) {
  ...
  # (from Vikas) ******NOTE: right now, idk how messages are being shared back to user, but the error messages do not 
  #specify that the column name must be all CAPS. Then, for some reason, he changes all column names to lower case? 
  # But we can do that later with a different function. 
...
>>>>>>> 3fc72a3d6c973d0e4624b44c1a884cff14e945bd:R/user_csv_survey.R
